...
class ReduxFramework_Extension_instagram_api_connector_field_extended extends Redux_Extension_Abstract {
    private $c;
    public function __construct( $parent, $path, $ext_class ) {
        $this->c = $parent->extensions['instagram_api_connector_field'];
