						...
						<td class="value">
							...
							if ( $variations_select_style ) {
								...
								wc_dropdown_variation_attribute_options(
									...
									echo end( $attribute_keys ) === $attribute_name ? wp_kses( apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations" href="' . esc_url( '#' ) . '">' . esc_html__( 'Clear', 'teta-lite' ) . '</a>' ), kite_allowed_html() ) : '';
							}
							?>
