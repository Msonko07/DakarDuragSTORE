...
if ( ! class_exists( 'Redux' ) ) {
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_i4x0prs7oo',
					'type'   => 'section',
					'indent' => true,
					'title'	 => esc_html( 'Responsive Header Settings', 'teta-lite' ),
				),
				array(
					'id'       => 'lite_option_u2ju7oatf9m',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_4di8gky3md3',
					'type'   => 'section',
					'title'  => esc_html__( 'Promo Bar Height', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'            => 'lite_option_iris4qpyg2',
					'type'          => 'slider',
				...
				array(
					'id'     => 'lite_option_zlmj6m323w',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_i7sw7bwv28c',
					'type'   => 'section',
					'title'  => esc_html__( 'Promo Bar Background Style', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_tsunr629mf9',
					'type'     => 'media',
					'operator' => 'and',
				...
				array(
					'id'     => 'lite_option_g2fkyjxfl2',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'       => 'lite_option_qxdr8iqn4wl',
					'type'     => 'switch',
	...
	Redux::setSection(
		$opt_name,
		array(
			'title'  => esc_html__( 'Search Options', 'teta-lite' ),
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'     => 'lite_option_sxnc7cnjdvo',
					'type'   => 'section',
					'title'  => esc_html__( 'Products Pagination', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_6g7jxnz5rn2',
					'type'     => 'select',
				...
				array(
					'id'     => 'lite_option_r0yj6iup4a',
					'title'	 =>	esc_html( 'Product Variations', 'teta-lite' ),
					'type'   => 'section',
					'indent' => true,
				),
				array(
					'id'      => 'lite_option_pv8vj34os8m',
					'type'    => 'switch',
				...
				array(
					'id'     => 'lite_option_uqd2mjqbbpi',
					'type'   => 'section',
					'title'  => esc_html__( 'Recently Viewed Products', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_893wtowcwsm',
					'type'     => 'switch',
					'title'    => esc_html__( 'Recently viewed products', 'teta-lite' ),
				...
				array(
					'id'     => 'lite_option_2akfbpa7jps',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_7h20cis0efc',
					'title'  => esc_html__( 'Catalog Mode', 'teta-lite' ),
					'type'   => 'section',
					'indent' => true,
				),
				array(
					'id'      => 'lite_option_uu6ml3nlbac',
					'type'    => 'switch',
				...
				array(
					'id'     => 'lite_option_62hbddgmvfl',
					'type'   => 'section',
					'title'	 => esc_html__( 'Widgets Settings', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_iftnw81ye2',
					'type'     => 'switch',
				...
				array(
					'id'     => 'lite_option_zd1bgjclty',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id' 		=> 'lite_option_6098nusv2v3',
					'type' 		=> 'section',
					'title' 	=> esc_html__( 'Shop Extra Templates', 'teta-lite' ),
					'indent' 	=> true,
				),
				array (
					'id'       => 'lite_option_v6ep2d5ui5f',
					'type'     => 'switch',
				...
				array(
					'id' => 'lite_option_4djzwgnlzmf',
					'type' => 'section',
					'indent' => false,
				),
				array(
					'id' => 'lite_option_8vylmeedi8w',
					'type' => 'section',
					'title' =>esc_html__( 'Shop Extra Options', 'teta-lite' ),
					'indent' => true,
				),
				array (
					'id'       => 'lite_option_b42xp3uzwft',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_mr51ptfyffk',
			'icon'   => 'icon-truck',
			'subsection' => true,
			'fields' => array(
				array (
					'id'       => 'lite_option_r1bn89mrgyg',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'       => 'lite_option_3kfsy2fjt76',
					'type'     => 'text',
					'title'    => esc_html__( 'WooCommerce ajax variation threshold', 'teta-lite' ),
					'subtitle' => esc_html__( 'Woocommerce by default Support 30  variation to show the gallery images, change the following number  to increase it', 'teta-lite' ),
					'default'  => 30,
					'class'    => 'kt-pro-feature'
				),
				array(
				...
				array(
					'id'     => 'lite_option_mzpjbnz8jt',
					'type'   => 'section',
					'title'	 => esc_html__( 'Add to cart', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_0a9pd1wejs36',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_axthy9hnslt',
			'icon'   => 'icon-cart-full',
			'subsection' => true,
			'fields' => array(
				array(
					'id'       => 'lite_option_k4yendkg90j',
					'type'     => 'switch',
				...
				array(
					'id'     => 'lite_option_jycratve55b',
					'type'   => 'section',
					'title'  => esc_html__( 'Size Guide', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_7hulw2ysi83',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_j2vcgu4fpsm',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_pnnsjm9puql',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_kr5ogv6rk6',
					'type'   => 'section',
					'title'    => esc_html__( 'Delivery & Return', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_xzw4d3hd8c',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_jmxy53b9yod',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_a10gcltwq4',
					'type'   => 'section',
					'indent' => false,
				),
				array(
					'id'     => 'lite_option_eqgdwqvlak',
					'type'   => 'section',
					'title'    => esc_html__( 'Ask a Question', 'teta-lite' ),
					'indent' => true,
				),
				array(
					'id'       => 'lite_option_zej76qur3fn',
					'type'     => 'text',
					'title'    => esc_html__( 'Title', 'teta-lite' ),
				...
				array(
					'id'       => 'lite_option_519rb23bbl',
					'type'     => 'editor',
					'class'    => 'kt-pro-feature'
				),
				array(
					'id'     => 'lite_option_1cvjt2xo1bi',
					'type'   => 'section',
					'indent' => false,
				),
			),
	...
	Redux::setSection(
		...
		array(
			...
			'id'     => 'lite_option_spjnqrnwa1r',
			'icon'   => 'icon-cart-full',
			'subsection' => true,
			'fields' => array(
				array(
					'id'       => 'lite_option_comjdyyqbo',
					'type'     => 'switch',
	...
	Redux::setSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'id'      => 'lite_option_znpki49ups',
					'type'    => 'switch',
					'title'   => esc_html__( 'Load Skeleton style in shop page', 'teta-lite' ),
					'default' => false,
					'on'      => esc_html__( 'Yes', 'teta-lite' ),
					'off'     => esc_html__( 'No', 'teta-lite' ),
					'class'   => 'kt-pro-feature'
				...
				array(
                    'id'       => 'lite_option_cgt851x7wio',
                    'type'     => 'switch',
                    'title'    => esc_html__( 'Disable redux gutenberg template library', 'teta-lite' ),
                    'subtitle' => esc_html__( 'To have better speed score, It\'s recommanded to enable this option.', 'teta-lite' ),
                    'on'       => esc_html__( 'Yes', 'teta-lite' ),
                    'off'      => esc_html__( 'No', 'teta-lite' ),
                    'default'  => true,
