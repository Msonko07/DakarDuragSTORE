...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_Extension_icon_picker_field' ) ) {
	/**
	 * Main ReduxFramework custom_field extension class
	 *
	 * @since       3.1.6
	 */
	class ReduxFramework_Extension_icon_picker_field extends ReduxFramework {

		// Set the version number of your extension here
		public static $version = '1.0.0';
		// Set the name of your extension here
		public $ext_name = 'icon_picker';
