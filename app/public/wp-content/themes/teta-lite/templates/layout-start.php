...
$main_content_classes['hasMobileTopbar'] = ( kite_opt( 'topbar_display', false ) && ( kite_opt( 'topbar-language-link-1', '' ) || kite_opt( 'topbar-language-link-2', '' ) || kite_opt( 'topbar-language-link-3', '' ) || kite_opt( 'topbar-language-link-4', '' ) || ( class_exists( 'WOOCS' ) && kite_opt( 'topbar_currency_shortcode', '[woocs show_flags=0 flag_position="left"]' ) ) ) ) ? 'has-mobile-topbar' : '';
