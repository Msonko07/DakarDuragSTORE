        ...
        ?>
                <div id="headersecondstate" class="hidden-phone hidden-tablet">
                    ...
                    <?php if ( $search == 1 ) { ?>
                        <?php 
                        $span_classes = '';
                        if ( is_active_sidebar( 'woocommerce_dropdown_cart ' ) ) { 
                            $span_classes .= ' has_dropdown_cart ';
                        } 
                        if ( kite_woocommerce_installed() && class_exists( 'YITH_WCWL' ) && kite_opt( 'header-wishlist-display', true ) == 1 ) {
                            $span_classes .= ' has_wishlist'; 
                        }
                        ?>
                        <span class="search-button icon-magnifier no-select hidden-phone hidden-tablet <?php echo esc_attr( $span_classes ); ?>"></span>
                    <?php } ?>
                    <?php if ( $menuInContainer == 0 ) { ?>
                        <!-- if menu be in container -->
                        </div>
